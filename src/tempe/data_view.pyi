...
class DataView(Generic[DataType]):
    ...
    def __floordiv__(self, other: DataType | Iterable[DataType]) -> DataView[DataType]: ...

    def __rfloordiv__(self, other: DataType | Iterable[DataType]) -> DataView[DataType]: ...

    def __truediv__(self, other: DataType | Iterable[DataType]) -> DataView[DataType]: ...

    def __rtruediv__(self, other: DataType | Iterable[DataType]) -> DataView[DataType]: ...
...
class Slice(DataView[DataType]):
    ...
    def __init__(self, data: Iterable[DataType], start: int, stop: int | None = None, step: int = 1): ...
